from mafia.game.player import Mafia, Sheriff, Doc, Citizen
from mafia.game.errors import *


class Game:
    def __init__(self, host_id: int, time: bool, players: dict[int, Mafia | Doc | Sheriff | Citizen]):
    ...
    def remove_player(self, target_id):
        return self.players.pop(target_id)
...
class GameCreator:
    ...
    def set_players(self, players: dict[int, Mafia | Doc | Sheriff | Citizen]):
        self.players = players
        return self
