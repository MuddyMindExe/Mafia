...
from mafia.game.errors import PlayerErrors, VotingErrors
...
class VotesManager:
    ...
    async def add_vote(self, inter_id: int, target_id: int) -> list[int] | None:
        async with self._lock:
            ...
            return await self.vote_result() if self.voters.not_voted_amt == 0 else None
